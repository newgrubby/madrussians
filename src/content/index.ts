...
type Content = {
  ...
  fieldLog: { eyebrow: string; title: [string, string]; items: { place: string; study: string; image: string }[] };
...
const ru: Content = {
  ...
  ].map((x, i) => ({ slug:x[0], destination:x[1], title:x[2], season:x[3], duration:x[4], group:x[5], image:expeditionImages[i] })) as Expedition[],
  ...
  fieldLog: { eyebrow: "03 / FIELD NOTES / DESTINATION STUDIES", title: ["ПОЛЕВОЙ", "ЖУРНАЛ"], items: [
    {place:"КАМЧАТКА",study:"ВУЛКАНЫ",image:"/images/madrussians/kamchatka-03.jpeg"}, {place:"БАЙКАЛ",study:"ЛЁД",image:"/images/madrussians/baikal-03.jpeg"}, {place:"ЧАРСКИЕ ПЕСКИ",study:"ПУСТЫНЯ",image:"/images/madrussians/chara-01.jpeg"}, {place:"КУРИЛЫ",study:"ТИХИЙ ОКЕАН",image:"/images/madrussians/kurils-02.jpeg"}, {place:"АЛТАЙ",study:"ВЫСОКОГОРЬЕ",image:"/images/madrussians/kyrgyzstan-03.jpeg"},
  ] },
...
const en: Content = {
  ...
  fieldLog:{eyebrow:"03 / FIELD NOTES / DESTINATION STUDIES",title:["FIELD","LOG"],items:[{place:"KAMCHATKA",study:"VOLCANOES",image:"/images/madrussians/kamchatka-03.jpeg"},{place:"LAKE BAIKAL",study:"ICE",image:"/images/madrussians/baikal-03.jpeg"},{place:"CHARA SANDS",study:"DESERT",image:"/images/madrussians/chara-01.jpeg"},{place:"KURILS",study:"PACIFIC OCEAN",image:"/images/madrussians/kurils-02.jpeg"},{place:"ALTAI",study:"HIGH COUNTRY",image:"/images/madrussians/kyrgyzstan-03.jpeg"}]},
